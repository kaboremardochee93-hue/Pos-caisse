...
### 1. Page de Connexion!
![alt text](Screanshot/Page_de_connexion.png)

### 2. Interface Caisse (panier vide)
![alt text](Screanshot/Interface_caisse_avec_pannier_vide.png)

### 3. Panier rempli + Total automatique
![alt text](Screanshot/interface_pannier-rempli.png)

### 4. Validation de vente
![alt text](Screanshot/validation_de_vente.png)

### 5. Reçu imprimé
![alt text](Screanshot/Reçu_imprimé.png)

### 6. Historique des ventes
![alt text](Screanshot/historique_des_ventes.png)

### 7. Détaille vente
![alt text](Screanshot/Détaille_vente.png)

### 8. Page avec produit modifié
![alt text](Screanshot/page_produit_modifié.png)
